...
from pomelo.ext.session import MySQLSession
from pomelo.handler import (orm_fields_all_to_list, orm_fields_one_to_dict,
                            orm_table_all_to_list, orm_table_one_to_dict)

__all__ = ['PomeloMySQLCURD']
...
class CURDTableBase(object):
    def __init__(self, session=MySQLSession.pomelo):
...
class PomeloTableCreate(CURDTableBase):
    def __init__(self, session=MySQLSession.pomelo):
...
class PomeloTableDelete(CURDTableBase):
    def __init__(self, session=MySQLSession.pomelo):
        super().__init__(session)
...
class PomeloTableUpdate(CURDTableBase):
    def __init__(self, session=MySQLSession.pomelo):
        super().__init__(session)
...
class PomeloTableRead(CURDTableBase):
    def __init__(self, session=MySQLSession.pomelo):
        super().__init__(session)
...
class PomeloMySQLCURD(PomeloTableCreate, PomeloTableUpdate, PomeloTableRead, PomeloTableDelete):
    def __init__(self, session=MySQLSession.pomelo):
        super().__init__(session)
